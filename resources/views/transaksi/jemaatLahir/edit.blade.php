    ...
    <div class="py-5" style="clear: both">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <form action="{{route('jemaatLahir.update',$jemaat->idJemaatLahir)}}" method="post">
                    @method('PUT')
                    @csrf
                    ...
                    <x-form-jemaat-lahir :jemaat="$jemaat" :ucapanSyukur="$ucapanSyukur"/>
                    ...
                    <x-back-button :link="url('/jemaatLahir')" />
                </form>
