    ...
    <div class="py-5" style="clear: both">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <form action="{{route('jemaatLahir.store')}}" method="post">
                    @method('POST')
                    @csrf
                    ...
                    <fieldset class="border-solid border-blue-500 border-2 px-4 pb-4">
                        ...
                        <input id="kepala_keluarga" type="text" name="kepala_keluarga" value="{{old('kepala_keluarga',$jemaat->kepala_keluarga)}}" placeholder="Arif Chandra Simanjuntak" class="rounded-md px-4 py-2 focus:outline-none bg-gray-100 lg:w-1/2 sm:w-full" autocomplete="off"/>
...
<script>
    ...
    const keluargaApi = document.getElementById("keluarga_api");
    ...
    const setSearchValue = (index) => {
        ...
        keluargaApi.value = res[index].id;
        matchList.innerHTML = '';
    }
