...
<form action="{{ route('jemaatBaru.index') }}" method="get" class="float-left m-5">
                    ...
                    <div class="float-left mr-4">
                        ...
                        <input type="text" name="search_year" value="{{ old('search_year', optional($filter)->search_year) }}" placeholder="Tahun Input" class="rounded-md px-4 py-2 focus:outline-none bg-gray-100 lg:w-60" />
                        ...
                        <table class="min-w-full table-auto">
                            <thead class="justify-between">
                                <tr class="bg-gray-800 text-white">
                                    ...
                                    <th class="px-16 py-2">Tanggal Input</th>
                                ...
                                <tbody class="bg-gray-200">
                                    @foreach ($jemaatBarus as $jemaatBaru)
                                        ...
                                        <td class="p-2 text-center">{{$jemaatBaru->created_at ? date("d-m-Y",strToTime($jemaatBaru->created_at)) : '-'}}</td>
                                        <td class="p-2 text-center">{{$jemaatBaru->sektor_id}}</td>
