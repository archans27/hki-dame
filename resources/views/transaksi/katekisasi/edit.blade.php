            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <form action="{{route('katekisasi.update',$katekisasi->id)}}" method="post">
                    ...
                    <fieldset class="border-solid border-blue-500 border-2 px-4 pb-4">
                        ...
                        <input id="jemaat_sugestion" type="text" name="nama" value="{{old('nama',$katekisasi->nama)}}" placeholder="Arif Chandra Simanjuntak" class="rounded-md px-4 py-2 focus:outline-none bg-gray-100 lg:w-1/2 sm:w-full" autocomplete="off" readonly="readonly"/>
                        ...
                        <input id="status" type="text" name="status" value="{{old('status',$katekisasi->status)}}" placeholder="Autofill" class="rounded-md px-4 py-2 focus:outline-none bg-gray-300 lg:w-1/2 sm:w-full cursor-not-allowed mt-3" readonly="readonly"/>
                </fieldset>
                    ...
                    <fieldset class="border-solid border-blue-500 border-2 px-4 pb-4 mt-5">
                        ...
                        <select name="kelas" class="w-1020 h-10  placeholder-gray-600 bg-gray-100 border rounded-md appearance-none focus:shadow-outline" placeholder="Golongan darah">
                            ...
                            <option value="R" @if (old('kelas',$katekisasi->kelas) == 'R') {{"selected"}}@endif>Reguler</option>
                            <option value="K" @if (old('kelas',$katekisasi->kelas) == 'K') {{"selected"}}@endif>Khusus</option>
                        </select>
                        @error('kelas')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
