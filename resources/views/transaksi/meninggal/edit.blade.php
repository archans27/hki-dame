            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <form action="{{route('meninggal.update',$meninggal->id)}}" method="post">
                    ...
                    <fieldset class="border-solid border-blue-500 border-2 px-4 pb-4">
                        ...
                        <input id="jemaat_sugestion" type="text" name="nama" value="{{old('nama',$meninggal->nama)}}" placeholder="Arif Chandra Simanjuntak" class="rounded-md px-4 py-2 focus:outline-none bg-gray-100 lg:w-1/2 sm:w-full" autocomplete="off" readonly="readonly"/>
